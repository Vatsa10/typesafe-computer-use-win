...
from typesafe_computer_use_win import runner, writer
from typesafe_computer_use_win.actions import Context
from typesafe_computer_use_win.runner import RunConfig, RunState, conclude, resolve
from typesafe_computer_use_win.writer import ANSWER_IMAGE_EDGE, Answer, compose_answer
...
def test_the_screen_is_captured_again_when_an_action_made_the_last_capture_stale(tmp_path, screen, make_item, monkeypatch):
    monkeypatch.setattr(runner.windows, "check_abort", lambda: None)
