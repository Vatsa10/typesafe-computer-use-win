...
OCR_REGION_PCT = "ocr_region_pct"  # share of the capture handed to the OCR engine
...
def format_timing(timing: dict[str, float]) -> str:
    ...
    What the OCR engine was given rides on the `ocr` phase: `ocr 0.31s (22% of screen, 2 rects)`. The rect
